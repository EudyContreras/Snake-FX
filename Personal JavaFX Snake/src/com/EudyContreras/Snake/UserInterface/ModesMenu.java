...
public class ModesMenu extends AbstractMenuElement{
	...
	private final static CustomMenuBox MODES_MENU_BOX = new CustomMenuBox(0,200,500,700,30,Color.BLACK,Pos.CENTER);

	public ModesMenu(GameManager game, GameMenuInterface menu){
		this.game = game;
		this.menu = menu;
		this.setUp();
	}
	public void setUp(){
		...
		MODES_MENU_BOX.addButtons(
				 new CustomMenuButton("CLASSIC MODE", Pos.CENTER, ButtonStyle.BLACK, Color.WHITE, fontSize, buttonSizeW, buttonSizeH,true),
				 new CustomMenuButton("TIME MODE", Pos.CENTER, ButtonStyle.BLACK, Color.WHITE, fontSize, buttonSizeW, buttonSizeH,true),
				 new CustomMenuButton("MULTIPLAYER", Pos.CENTER, ButtonStyle.BLACK, Color.WHITE, fontSize, buttonSizeW, buttonSizeH,true),
				 new CustomMenuButton("GO BACK", Pos.CENTER, ButtonStyle.BLACK, Color.WHITE, fontSize, buttonSizeW, buttonSizeH,true)
				);
		}
