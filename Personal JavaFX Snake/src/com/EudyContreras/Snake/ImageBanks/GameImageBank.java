...
public class GameImageBank {
	...
	public static Image game_draw_trans_board;
	public static Image game_draw_score_board;
	...
	public GameImageBank() {
		...
		game_draw_trans_board = new Image(ImageEffectUtility.loadResource("game_draw_transition_board.png"));
		game_draw_score_board = new Image(ImageEffectUtility.loadResource("game_draw_score_board.png"));
