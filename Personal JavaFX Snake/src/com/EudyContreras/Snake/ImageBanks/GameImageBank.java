...
import javafx.scene.shape.Circle;
	...
	public class GameImageBank {
			...
			public static ImageCursor horizontalDrag = new ImageCursor(new Image(ImageEffectUtility.loadResource("horizontalDrag.png")));
			public static ImageCursor verticalDrag = new ImageCursor(new Image(ImageEffectUtility.loadResource("verticalDrag.png")));
			public static ImageCursor diagonalDragNE_SW = new ImageCursor(new Image(ImageEffectUtility.loadResource("diagonalDragNE_SW.png")));
			public static ImageCursor diagonalDragNW_SE = new ImageCursor(new Image(ImageEffectUtility.loadResource("diagonalDragNW_SE.png")));
		/**
		 * general game object
		 */
