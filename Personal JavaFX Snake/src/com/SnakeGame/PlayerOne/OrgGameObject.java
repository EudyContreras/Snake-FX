...
public abstract class OrgGameObject {
	 ...
	 * @param id
	 */
    public OrgGameObject(SnakeGame game, Pane layer, Image image, float x, float y, float r, float velX, float velY, float velR, double health, double damage, GameObjectID id) {
    ...
    public OrgGameObject(SnakeGame game, Pane layer, Node node, float x, float y, float r, float velX, float velY, float velR, double health, double damage, GameObjectID id) {
    ...
    public OrgGameObject(SnakeGame game, Image image, Pane layer, float x, float y, float r, float velX, float velY, GameObjectID id) {
    	this.layer = layer;
        this.image = image;
        this.x = x;
        this.y = y;
    ...
    public OrgGameObject(SnakeGame game, Pane layer, float x, float y, float r, float velX, float velY, GameObjectID id) {
    	this.layer = layer;
        this.x = x;
        this.y = y;
        this.r = r;
