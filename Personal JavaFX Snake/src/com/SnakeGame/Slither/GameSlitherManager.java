...
/**
 * This manager class is the core of every game object and is responsible
 * for updating, drawing, adding physics, animating, removing, moving every object
 * and checking whether the objects is alive or not meaning no longer used. the objects
 * updated by this class are mob objects meaning objects that move, interact and collide.
...
public class GameSlitherManager {
    ...
    /**
     * Method used to update every object in the game.
