 ...
 *
 */
public class LittleCactus extends AbstractTile {
	...
	public LittleCactus(SnakeGame game, float x, float y, float velX, float velR, Image image, GameLevelObjectID id) {
		super(x, y, image, id);
		this.oldX = x;
