...
public class Slither extends SlitherMain3 {
	...
	public void move() {
		...
		snakeHead.setPosX((float) (snakeHead.getPosX()
				+ Math.sin(Math.toRadians(snakeHead.getRotDegree())) * snakeHead.getSpeed() * delta));
		snakeHead.setPosY((float) (snakeHead.getPosY()
				+ Math.cos(Math.toRadians(snakeHead.getRotDegree())) * snakeHead.getSpeed() * delta));
