...
public class MenuMultiplayer {
	...
	public void setupMultiplayerMenu() {
		...
		VBox.setMargin(startServerLabel,
				new Insets(20 / GameLoader.ResolutionScaleY, 20, 20, 20 / GameLoader.ResolutionScaleY));
		VBox.setMargin(connectToServerLabel,
				new Insets(20 / GameLoader.ResolutionScaleY, 20, 20, 20 / GameLoader.ResolutionScaleY));

		startServerLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Impact; -fx-font-size: "
				+ 36 / GameLoader.ResolutionScaleY + "px");
		connectToServerLabel.setAlignment(Pos.CENTER);

		r1 = new Rectangle(Settings.WIDTH / 2 - 250 / 2, serverBox.getTranslateY() / GameLoader.ResolutionScaleY, 250,
		...
		startServerLabel.setStyle("-fx-text-fill: #DBA901; -fx-font-family: Impact; -fx-font-size: "
				+ 36 / GameLoader.ResolutionScaleY + "px");
	...
	// */
	// if (currentChoice == 1) {
	// soundLabel.setStyle("-fx-text-fill: #DBA901; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// modeLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// controllsLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// settingsLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// backLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	//
	// } else if (currentChoice == 2) {
	// modeLabel.setStyle("-fx-text-fill: #DBA901; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// soundLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// controllsLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// settingsLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	...
	// controllsLabel.setStyle("-fx-text-fill: #DBA901; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// modeLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// soundLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	...
	// settingsLabel.setStyle("-fx-text-fill: #DBA901; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// modeLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// soundLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	...
	// backLabel.setStyle("-fx-text-fill: #DBA901; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// settingsLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
	// -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
	// modeLabel.setStyle("-fx-text-fill: #F5F6CE; -fx-font-family: Impact;
