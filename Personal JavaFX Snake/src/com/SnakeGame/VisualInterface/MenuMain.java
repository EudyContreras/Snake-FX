...
//    	}
    ...
    //    titleBox.getChildren().add(new Rectangle(900,200,new ImagePattern(MenuImageBank.startLogo)));
        ...
        VBox.setMargin(startLabel, new Insets(20/GameLoader.ResolutionScaleY, 20, 20, 20/GameLoader.ResolutionScaleY));
        VBox.setMargin(multiplayerLabel, new Insets(20/GameLoader.ResolutionScaleY, 20, 20, 20/GameLoader.ResolutionScaleY));
        VBox.setMargin(optionsLabel, new Insets(20/GameLoader.ResolutionScaleY, 20, 20, 20/GameLoader.ResolutionScaleY));
        VBox.setMargin(highScoreLabel, new Insets(20/GameLoader.ResolutionScaleY, 20, 20, 20/GameLoader.ResolutionScaleY));
        VBox.setMargin(exitLabel, new Insets(20/GameLoader.ResolutionScaleY, 20, 20, 20/GameLoader.ResolutionScaleY));

        startLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
        ...
        r1 = new Rectangle(Settings.WIDTH/2 - 250/2,menuBox.getTranslateY()/GameLoader.ResolutionScaleY,250,50/GameLoader.ResolutionScaleY);
...
//        r4.setFill(Color.TRANSPARENT);
        r5 = new Rectangle(Settings.WIDTH/2 - 250/2,r4.getY()+r4.getHeight()+(20/GameLoader.ResolutionScaleY),250,50/GameLoader.ResolutionScaleY);
...
//        r4.setFill(Color.TRANSPARENT);
        ...
        VBox.setMargin(r1, new Insets(20/GameLoader.ResolutionScaleY, 20/GameLoader.ResolutionScaleY, 20, 20/GameLoader.ResolutionScaleY));
        VBox.setMargin(r2, new Insets(15/GameLoader.ResolutionScaleY, 20/GameLoader.ResolutionScaleY, 20, 20/GameLoader.ResolutionScaleY));
        VBox.setMargin(r3, new Insets(15/GameLoader.ResolutionScaleY, 20/GameLoader.ResolutionScaleY, 20, 20/GameLoader.ResolutionScaleY));
        VBox.setMargin(r4, new Insets(15/GameLoader.ResolutionScaleY, 20/GameLoader.ResolutionScaleY, 20, 20/GameLoader.ResolutionScaleY));
        VBox.setMargin(r5, new Insets(15/GameLoader.ResolutionScaleY, 20/GameLoader.ResolutionScaleY, 20, 20/GameLoader.ResolutionScaleY));
    ...
    public void setTitleStyle(Label label) {
        ...
        label.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+170/GameLoader.ResolutionScaleY+"px;");
    	...
    	game.getScene().setOnKeyPressed(e -> {
    		switch (e.getCode()) {
                ...
                case ENTER:
                    ...
                    if (currentChoice == 3) { multiplayerMenu();
                    }
                    if (currentChoice == 4) { //highScore();
                    }
                    if (currentChoice == 5) { closeGame();
                    }
				    break;
                case SPACE:
                    if (currentChoice == 1) { startSelected();
            ...
            if (currentChoice == 1) {
                startLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                optionsLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                multiplayerLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                highScoreLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                exitLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
            } else if (currentChoice == 2) {
                optionsLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                multiplayerLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                startLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                highScoreLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                exitLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
            } else if (currentChoice == 3) {
            	multiplayerLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                highScoreLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                exitLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                startLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                optionsLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
            } else if (currentChoice == 4) {
            	highScoreLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                multiplayerLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                exitLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                startLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                optionsLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
            } else if (currentChoice == 5) {
                exitLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                multiplayerLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                highScoreLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                startLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                optionsLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Impact; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
     ...
     * Shows the cursor, sets the root of the game to menu root and pauses the game.
     */
