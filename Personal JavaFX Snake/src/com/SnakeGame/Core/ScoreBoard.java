...
/**
 * This class is used for holding and displaying a score
 * which can the be stored.
...
public class ScoreBoard {
	...
	public ScoreBoard(String text,SnakeGame game, double x1, double y1,double x, double y, double width, double height) {
		this.x = x;
		this.y = y;
		this.message = text;
		this.width = width;
