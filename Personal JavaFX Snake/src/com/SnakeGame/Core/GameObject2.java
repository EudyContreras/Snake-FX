...
public abstract class GameObject2 {
	 ...
	 * @param id
	 */
    public GameObject2(SnakeGame game, Pane layer, Image image, float x, float y, float r, float velX, float velY, float velR, double health, double damage, GameObjectID id) {
    ...
    public GameObject2(SnakeGame game, Pane layer, Node node, float x, float y, float r, float velX, float velY, float velR, double health, double damage, GameObjectID id) {
    ...
    public GameObject2(SnakeGame game, Image image, Pane layer, float x, float y, float r, float velX, float velY, GameObjectID id) {
    	this.layer = layer;
        this.image = image;
        this.x = x;
        this.y = y;
    ...
    public GameObject2(SnakeGame game, Pane layer, float x, float y, float r, float velX, float velY, GameObjectID id) {
    	this.layer = layer;
        this.x = x;
        this.y = y;
        this.r = r;
    ...
    public GameObject2(SnakeGame game, Pane layer, Image image, float x, float y, GameObjectID id) {
    	this.layer = layer;
        this.image = image;
        this.x = x;
        this.y = y;
    ...
    public GameObject2(SnakeGame game, Pane layer, Node node, float x, float y, GameObjectID id) {
    	this.layer = layer;
        this.x = x;
        this.y = y;
        this.id = id;
    ...
    public GameObject2( Image image, float x, float y) {
        this.image = image;
        this.x = x;
        this.y = y;
        this.imageView.setImage(image);
    ...
    public GameObject2(SnakeGame game, Pane layer, GameObjectID id) {
    	this.layer = layer;
        this.id = id;
    }
