...
//		Pane appleRoot = new Pane();
		...
		food.setTranslateX((int) (Math.random() * (Width-food.getRadius() - food.getRadius() + 1)+food.getRadius()));
		food.setTranslateY((int) (Math.random() * (Height-food.getRadius() - food.getRadius() + 1)+food.getRadius()));
