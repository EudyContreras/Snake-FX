...
public class Player2 extends GameObject {
    ...
    public Player2(SnakeGame game, Pane layer, Node node, double x, double y, double r, double velX, double velY, double velR, double health, double damage, double speed, GameObjectID id, GameObjectManager gom) {
        ...
        this.snakeHead = new SnakeHead2(this,game,layer,GameImageBank.snakeSphere2, this.x, this.y, GameObjectID.SnakeMouth, PlayerMovement.MOVE_DOWN);
        this.mouth = new SnakeMouth2(this,game, game.getSnakeHeadLayer(), new Circle(Settings.SECTION_SIZE*0.30/GameLoader.ResolutionScaleX,Color.TRANSPARENT), this.x, this.y, GameObjectID.SnakeMouth, PlayerMovement.MOVE_LEFT);
