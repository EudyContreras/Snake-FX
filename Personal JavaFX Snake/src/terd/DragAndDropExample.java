...
public class DragAndDropExample extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        scene = new Scene(layout, 800, 800, Color.WHITE);
        ...
        contentPane.setOnDragExited(e -> contentPane.setStyle("-fx-border-color: #C6C6C6;"));
    ...
    void addImage(Image i, Pane pane){
        ...
        imageView.setFitWidth(i.getWidth());
        imageView.setFitHeight(i.getHeight());
    	scene.setOnMouseEntered(new EventHandler<MouseEvent>() {
			public void handle(MouseEvent event) {

				x = event.getSceneX()- imageView.getFitWidth()/2;
				y = event.getSceneY()- imageView.getFitHeight()/2;
