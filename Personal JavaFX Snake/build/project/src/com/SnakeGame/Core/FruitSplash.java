...
public class FruitSplash extends DebrisEffect{
	...
	public FruitSplash(SnakeGame game,Paint fill, double expireTime, double radius, double x, double y) {
		...
		this.color = fill;
		this.velX = (Math.random()*(10 - -10 + 1) + -10)/(GameLoader.ResolutionScaleX+GameLoader.ResolutionScaleY/2);
		this.velY = (Math.random()*(10 - -10 + 1) + -10)/(GameLoader.ResolutionScaleX+GameLoader.ResolutionScaleY/2);
		this.x = x;
		this.y = y;
