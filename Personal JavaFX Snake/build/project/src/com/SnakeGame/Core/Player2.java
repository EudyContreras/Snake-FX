...
public class Player2 extends GameObject {
    ...
    public Player2(SnakeGame game, Pane layer, Node node, double x, double y, double r, double velX, double velY, double velR, double health, double damage, double speed, GameObjectID id, GameObjectManager gom) {
        ...
        this.loadImages();
        this.mouth = new SnakeMouth2(this,game, game.getBottomLayer(), new Circle(Settings.SECTION_SIZE*0.30/GameLoader.ResolutionScaleX,Color.TRANSPARENT), this.x, this.y, GameObjectID.SnakeMouth, PlayerMovement.MOVE_LEFT);
        this.trigger = new EatTrigger2(this,game, game.getSnakeHeadLayer(),  new Circle(Settings.SECTION_SIZE*0.8/GameLoader.ResolutionScaleX,Color.TRANSPARENT), this.x, this.y, GameObjectID.SnakeMouth, PlayerMovement.MOVE_LEFT);
    ...
    public void addSection(){
        ...
        sectManager.addSection(new SnakeSection2(this,game, game.getSnakeBodyLayer(), new Circle(Settings.SECTION_SIZE,new ImagePattern(GameImageBank.snakeBody2)), x, y, GameObjectID.SnakeSection, getCurrentDirection(), NUMERIC_ID));
        SnakeGame.writeToLog("New section added "+ NUMERIC_ID);
        NUMERIC_ID++;
        }
        game.getScoreBoard2().increaseScore();
