...
public abstract class GameObject {
	 ...
	 * @param id
	 */
    public GameObject(SnakeGame game, Pane layer, Image image, double x, double y, double r, double velX, double velY, double velR, double health, double damage, GameObjectID id) {
    ...
    public GameObject(SnakeGame game, Pane layer, Node node, double x, double y, double r, double velX, double velY, double velR, double health, double damage, GameObjectID id) {
    ...
    public GameObject(SnakeGame game, Image image, Pane layer, double x, double y, double r, double velX, double velY, GameObjectID id) {
    	this.layer = layer;
        this.image = image;
        this.x = x;
        this.y = y;
    ...
    public GameObject(SnakeGame game, Pane layer, double x, double y, double r, double velX, double velY, GameObjectID id) {
    	this.layer = layer;
        this.x = x;
        this.y = y;
        this.r = r;
    ...
    public GameObject(SnakeGame game, Pane layer, Image image, double x, double y, GameObjectID id) {
    	this.layer = layer;
        this.image = image;
        this.x = x;
        this.y = y;
    ...
    public GameObject(SnakeGame game, Pane layer, Node node, double x, double y, GameObjectID id) {
    	this.layer = layer;
        this.x = x;
        this.y = y;
        this.id = id;
    ...
    public GameObject(SnakeGame game, Pane layer, Node node, GameObjectID id) {
    	this.layer = layer;
        this.id = id;
        if(node instanceof Rectangle){
        	this.rect = (Rectangle)node;
