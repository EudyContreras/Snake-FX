...
public class MenuSound {
    ...
    public void setupSoundsMenu(){
        ...
        volumeBox.getChildren().addAll(slider);
        ...
        soundsBox.setTranslateX(550);
        soundsBox.setTranslateY(240);
        volumeBox.setTranslateX(790);
        volumeBox.setTranslateY(280);
        // addBackgroundImages();
        soundsRoot.getChildren().addAll(titleBox, soundsBox, volumeBox, r1,r2,r3,r4);
        volumeLabel.setStyle("-fx-text-fill: #0040FF; -fx-font-family: Ubuntu; -fx-font-size: 36px");
    }
    ...
    public void setKeyInputHandler() {
    	...
    	game.getScene().setOnKeyPressed(e -> {
            ...
            if (currentChoice == 1) {
                volumeLabel.setStyle("-fx-text-fill: #0040FF; -fx-font-family: Ubuntu; -fx-font-size: 36px");
                soundFXLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: 36px");
                musicLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: 36px");
                backLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: 36px");

            } else if (currentChoice == 2) {
            	 soundFXLabel.setStyle("-fx-text-fill: #0040FF; -fx-font-family: Ubuntu; -fx-font-size: 36px");
                 volumeLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: 36px");
                 musicLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: 36px");
                 backLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: 36px");

            } else if (currentChoice == 3) {
            	 musicLabel.setStyle("-fx-text-fill: #0040FF; -fx-font-family: Ubuntu; -fx-font-size: 36px");
                 volumeLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: 36px");
                 soundFXLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: 36px");
                 backLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: 36px");
