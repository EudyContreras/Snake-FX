	...
	public SnakeSection(Player snake, SnakeGame game, Pane layer, Circle node, double x, double y, GameObjectID id, PlayerMovement Direction, int numericID) {
		...
		if (this.numericID <= 0) {
			if (Direction == PlayerMovement.MOVE_UP) {
				...
				tail = new SnakeTail(this,game, game.getBottomLayer(), new Circle(Settings.SECTION_SIZE-5,new ImagePattern(GameImageBank.snakeTail)), this.x, this.y, GameObjectID.SnakeTail, PlayerMovement.MOVE_UP);
				...
				this.velY = snake.getVelY();
				setLastPosition(new Point2D(this.x,this.y));
				tail = new SnakeTail(this,game, game.getBottomLayer(), new Circle(Settings.SECTION_SIZE-5,new ImagePattern(GameImageBank.snakeTail)), this.x, this.y, GameObjectID.SnakeTail, PlayerMovement.MOVE_DOWN);
				game.getObjectManager().addObject(tail);
				snake.setTail(tail);
				snake.setNeighbor(this);
				if(this.numericID == Player.NUMERIC_ID){
				...
				this.velY = snake.getVelY();
				setLastPosition(new Point2D(this.x,this.y));
				tail = new SnakeTail(this,game, game.getBottomLayer(), new Circle(Settings.SECTION_SIZE-5,new ImagePattern(GameImageBank.snakeTail)), this.x, this.y, GameObjectID.SnakeTail, PlayerMovement.MOVE_LEFT);
				game.getObjectManager().addObject(tail);
				snake.setTail(tail);
				snake.setNeighbor(this);
				if(this.numericID == Player.NUMERIC_ID){
				...
				this.velY = snake.getVelY();
				setLastPosition(new Point2D(this.x,this.y));
				tail = new SnakeTail(this,game, game.getBottomLayer(), new Circle(Settings.SECTION_SIZE-5,new ImagePattern(GameImageBank.snakeTail)), this.x, this.y, GameObjectID.SnakeTail, PlayerMovement.MOVE_RIGHT);
				game.getObjectManager().addObject(tail);
				snake.setTail(tail);
				snake.setNeighbor(this);
				if(this.numericID == Player.NUMERIC_ID){
...
//			velY = 0;
//		}
//		if(!stopped == true && Player.keepMoving){
//			velX = lastVelX;
//			velY = lastVelY;
//			stopped = false;
//		}
