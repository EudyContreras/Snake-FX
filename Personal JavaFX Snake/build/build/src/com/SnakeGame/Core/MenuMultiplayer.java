...
public class MenuMultiplayer {
    ...
    public MenuMultiplayer(SnakeGame game) {
        this.game = game;
    ...
    public void setupMainMenu() {
        ...
        menuBox.getChildren().addAll(startLabel, optionsLabel, highScoreLabel, exitLabel);
        ...
        startLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
...
//        r4.setFill(Color.rgb(255, 0, 0,0.5));
    ...
    private void setStyle(Label label) {
        label.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px;");
    ...
    public void setTitleStyle(Label label) {
        ...
        label.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+170/GameLoader.ResolutionScaleY+"px;");
    ...
    private void setKeyInputHandler() {
    	...
    	game.getScene().setOnKeyPressed(e -> {
            ...
            if (currentChoice == 1) {
                startLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                optionsLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                highScoreLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                exitLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
            } else if (currentChoice == 2) {
                optionsLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                startLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                highScoreLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                exitLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
            } else if (currentChoice == 3) {
            	highScoreLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                exitLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                startLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                optionsLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
            } else if (currentChoice == 4) {
                exitLabel.setStyle("-fx-text-fill: #A5DF00; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                highScoreLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                startLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
                optionsLabel.setStyle("-fx-text-fill: #E1F5A9; -fx-font-family: Ubuntu; -fx-font-size: "+36/GameLoader.ResolutionScaleY+"px");
            }
...
//			highScores();
    ...
    private void OptionsMenu() {
    	 ...
    	 optionsMenu.setCurrentChoice(1);
    }
